    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Laporan Barang Rusak Luar</h4>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-12 mb-5">
                        <form action="{{ url('/laporan/rusakLuar') }}" method="POST">
                            @csrf
                            @method('POST')
                            <div class="row">
                                <div class="col-md-4">
                    ...
                    <div class="col">
                        <table id="example" class="table table-striped table-bordered datatables" style="width:100%">
                            ...
                            <tbody>
                                @if (isset($rusakLuar) && !$rusakLuar->isEmpty())
                                    @foreach ($rusakLuar as $item)
                                        @if($item->status > 1)
                                            <tr>
